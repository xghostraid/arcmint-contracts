 ...
 *
 *   node scripts/set-arc-rpc.mjs "https://rpc.mainnet.arc.io"
...
const fallback =
  fallbackIdx >= 0
    ? args[fallbackIdx + 1]
    : 'https://rpc.blockdaemon.mainnet.arc.io,https://5042.rpc.thirdweb.com';
...
Official Arc Mainnet RPC (chain 5042):
...
try {
  ...
  console.error('Fix: use https://rpc.mainnet.arc.io (chain 5042) or another Arc Mainnet HTTPS RPC.');
  process.exit(2);
}
